...
const SCALA_VERSION = '3.7.1-RC1'; // Update this when the project's Scala version changes

// Import the compiled Scala.js modules
import * as Chester from './js/target/scala-3.7.1-RC1/js-for-lua-fastopt/main.mjs';
