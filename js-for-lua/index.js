...
const SCALA_VERSION = '3.7.0-RC4'; // Update this when the project's Scala version changes

// Import the compiled Scala.js modules
import * as Chester from './js/target/scala-3.7.0-RC4/js-for-lua-fastopt/main.mjs';
