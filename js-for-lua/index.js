...
const SCALA_VERSION = '3.6.4'; // Update this when the project's Scala version changes

// Import the compiled Scala.js modules
import * as Chester from './js/target/scala-3.6.4/js-for-lua-fastopt/main.mjs';
