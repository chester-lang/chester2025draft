...
/**
 * Entry point for Scala code that will be compiled to Lua
 * Exports functions using JSExportTopLevel which will be available in Lua
 */
object LuaExports {
  ...
  /**
   * Entry point to access all chester functionality
   * This creates a top-level Chester object that can be accessed in Lua
   */
