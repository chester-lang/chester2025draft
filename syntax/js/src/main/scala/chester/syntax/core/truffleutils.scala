...
/** No-op version of the @child annotation for JS platform.
  *
  * Mirrors the Truffle annotation used on the JVM platform.
  */
class child extends StaticAnnotation

/** No-op version of the @const annotation for JS platform.
  *
  * Mirrors the Truffle annotation used on the JVM platform.
  */
class const extends StaticAnnotation

/** No-op version of the @children annotation for JS platform.
  *
  * Mirrors the Truffle annotation used on the JVM platform.
  */
