...
lazy val compiler213 = crossProject(JSPlatform, JVMPlatform)
  ...
  .settings(
    scala2Common,
    libraryDependencies += ("org.scalameta" %%% "scalameta" % "4.12.5")
...
object GeneratedJS {
  val jsCode: String = \"\"\"$escapedJsContent\"\"\"
    ...
    libraryDependencies ++= Seq(
      ...
      "org.scalameta" %% "semanticdb-shared" % "4.12.5" cross (CrossVersion.for3Use2_13) exclude ("com.lihaoyi", "sourcecode_2.13") exclude (
        "org.jline",
        "jline"
      ),
