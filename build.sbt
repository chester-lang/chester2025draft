...
val scala3Nightly = "3.7.2-RC1-bin-20250602-4d7d383-NIGHTLY"
...
ThisBuild / version := sys.env.getOrElse("VERSION", "0.0.34")
...
lazy val platform = crossProject(JSPlatform, JVMPlatform, NativePlatform)
  ...
  .jvmSettings(
    ...
    libraryDependencies ++= Seq(
      ...
      "org.scalameta" %% "semanticdb-shared" % "4.13.6" cross CrossVersion.for3Use2_13 exclude ("com.lihaoyi", "sourcecode_2.13") exclude (
        "org.jline",
        "jline"
      ),
