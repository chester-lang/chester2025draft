...
class StringIndexSuite extends FunSuite {
  test("charIndexToUnicodeIndex for simple characters") {
    ...
    assertEquals(sp.charIndexToUnicodeIndex(0).asInt, 0)
  ...
  test("charIndexToUnicodeIndex for characters with surrogate pairs") {
    ...
    assertEquals(sp.charIndexToUnicodeIndex(0).asInt, 0)
    assertEquals(sp.charIndexToUnicodeIndex(1).asInt, 1)
  ...
  test("charIndexToCharLineAndColumn for single line string") {
    ...
    assertEquals(sp.charIndexToCharLineAndColumn(4), LineAndColumn(0, Nat(4)))
  }

  test("charIndexToCharLineAndColumn for multi-line string") {
    val sp = StringIndex("hello\nworld")
    assertEquals(sp.charIndexToCharLineAndColumn(0), LineAndColumn(0, 0))
    assertEquals(sp.charIndexToCharLineAndColumn(5), LineAndColumn(0, Nat(5)))
    assertEquals(sp.charIndexToCharLineAndColumn(6), LineAndColumn(1, 0))
    assertEquals(sp.charIndexToCharLineAndColumn(11), LineAndColumn(1, Nat(5)))
  }
  ...
  test("charIndexToUnicodeLineAndColumn for single line string") {
    ...
    assertEquals(sp.charIndexToUnicodeLineAndColumn(4), LineAndColumn(0, Nat(4)))
  }
  ...
  test(
    ...
    val sp = StringIndex("hello\n\uD834\uDD1Eworld")
    assertEquals(sp.charIndexToUnicodeLineAndColumn(0), LineAndColumn(0, 0))
    assertEquals(sp.charIndexToUnicodeLineAndColumn(5), LineAndColumn(0, Nat(5)))
  ...
  test(
    ...
    assertEquals(sp.charIndexToUnicodeLineAndColumn(6), LineAndColumn(1, 0))
    assertEquals(sp.charIndexToUnicodeLineAndColumn(8), LineAndColumn(1, 1))
    assertEquals(sp.charIndexToUnicodeLineAndColumn(13), LineAndColumn(1, Nat(6)))
    assertEquals(sp.charIndexToUnicodeLineAndColumn(14), LineAndColumn(Nat(2), 0))
    assertEquals(
  ...
  test("charIndexToCharLineAndColumn for multi-line Chinese string") {
    ...
    assertEquals(sp.charIndexToCharLineAndColumn(2), LineAndColumn(0, Nat(2)))
  ...
  test("charIndexToUnicodeLineAndColumn for multi-line Chinese string") {
    ...
    assertEquals(sp.charIndexToUnicodeLineAndColumn(2), LineAndColumn(0, Nat(2)))
  ...
  test("charIndexToUnicodeIndex for Chinese characters with surrogate pairs") {
    ...
    assertEquals(sp.charIndexToUnicodeIndex(0).asInt, 0)
    assertEquals(sp.charIndexToUnicodeIndex(1).asInt, 0)
    assertEquals(sp.charIndexToUnicodeIndex(Nat(2)).asInt, 1)
    assertEquals(sp.charIndexToUnicodeIndex(Nat(3)).asInt, 2)
  ...
  test(
    ...
    assertEquals(sp.charIndexToCharLineAndColumn(1), LineAndColumn(0, 1))
    assertEquals(sp.charIndexToCharLineAndColumn(2), LineAndColumn(0, Nat(2)))
    assertEquals(sp.charIndexToCharLineAndColumn(3), LineAndColumn(0, Nat(3)))
    ...
    assertEquals(sp.charIndexToCharLineAndColumn(6), LineAndColumn(1, Nat(2)))
  }
  ...
  test(
    ...
    assertEquals(sp.charIndexToUnicodeLineAndColumn(3), LineAndColumn(0, Nat(2)))
